...
- Name: app.spec.ts >> System Design Visualizer >> should show simulation panel
- Location: tests/e2e/app.spec.ts:13:3
...
Locator: getByRole('button', { name: 'Start Simulation' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Start Simulation' })
