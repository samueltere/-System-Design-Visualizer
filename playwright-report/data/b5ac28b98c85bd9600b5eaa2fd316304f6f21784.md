...
Locator: getByText('Simulation')
Expected: visible
Error: strict mode violation: getByText('Simulation') resolved to 2 elements:
    1) <h3 class="font-bold text-gray-800">Simulation</h3> aka getByRole('heading', { name: 'Simulation' })
    2) <button class="w-full py-2 rounded-lg font-bold transition-all flex items-center justify-center gap-2 bg-green-600 text-white hover:bg-green-700 shadow-green-200 shadow-lg">Start Simulation</button> aka getByRole('button', { name: 'Start Simulation' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Simulation')
...
> 14 |     await expect(page.getByText('Simulation')).toBeVisible();
     |                                                ^ Error: expect(locator).toBeVisible() failed
  ...
  19 |     await expect(page.getByText('Components')).toBeVisible();
