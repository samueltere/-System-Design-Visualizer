...
Locator: getByText('Components')
Expected: visible
Error: strict mode violation: getByText('Components') resolved to 2 elements:
    1) <h2 class="text-lg font-bold mb-4 text-gray-800">Components</h2> aka getByRole('heading', { name: 'Components' })
    2) <p class="text-sm text-gray-500 mb-6">Drag components to the canvas to start designing.</p> aka getByText('Drag components to the canvas')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Components')
