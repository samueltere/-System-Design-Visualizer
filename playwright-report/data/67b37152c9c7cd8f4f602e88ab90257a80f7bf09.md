...
- Name: app.spec.ts >> System Design Visualizer >> should show sidebar with components
- Location: tests/e2e/app.spec.ts:18:3
...
Locator: getByText('Database')
Expected: visible
Error: strict mode violation: getByText('Database') resolved to 2 elements:
    1) <span class="text-sm font-medium text-gray-700">Database</span> aka getByText('Database', { exact: true })
    2) <span>Database: Firestore</span> aka getByText('Database: Firestore')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Database')
